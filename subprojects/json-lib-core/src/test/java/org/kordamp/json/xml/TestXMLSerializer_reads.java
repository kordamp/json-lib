...
public class TestXMLSerializer_reads extends TestCase {
    ...
    public void testReadObjectFullTypes() {
        ...
        expected.element("int", Integer.valueOf(1));
        expected.element("decimal", Double.valueOf(2.0));
        expected.element("number", Double.valueOf(3.1416));
    ...
    public void testRemoveNameSpacePrefixFromElements() throws Exception {
        ...
        JSONObject json = (JSONObject) xmlSerializer.readFromFile("org/kordamp/json/xml/delicious.xml");
    ...
    public void testTrimSpaces() throws Exception {
        ...
        json = (JSONObject) xmlSerializer.readFromFile("org/kordamp/json/xml/delicious.xml");
